...
DESCRIPTOR = _descriptor.FileDescriptor(
    ...
    dependencies=[
        ...
        promotion_dot_grpc_dot_v1alpha1_dot_discount__pb2.DESCRIPTOR,
    ],
)
...
_CREATEUSERREQUESTRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="user_id",
            full_name="promotion.grpc.v1alpha1.CreateUserRequestResponse.user_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="date_of_birth",
            full_name="promotion.grpc.v1alpha1.CreateUserRequestResponse.date_of_birth",
            index=1,
            number=2,
            type=11,
            cpp_type=10,
...
_RETRIEVEPROMOTIONREQUEST = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="user_id",
            full_name="promotion.grpc.v1alpha1.RetrievePromotionRequest.user_id",
            index=0,
            number=1,
            type=9,
            cpp_type=9,
        ...
        _descriptor.FieldDescriptor(
            name="product_id",
            full_name="promotion.grpc.v1alpha1.RetrievePromotionRequest.product_id",
            index=1,
            number=2,
            type=9,
            cpp_type=9,
...
_RETRIEVEPROMOTIONRESPONSE = _descriptor.Descriptor(
    ...
    fields=[
        _descriptor.FieldDescriptor(
            name="discounts",
            full_name="promotion.grpc.v1alpha1.RetrievePromotionResponse.discounts",
            index=0,
            number=1,
            type=11,
            cpp_type=10,
...
_CREATEUSERREQUESTRESPONSE.fields_by_name[
    "date_of_birth"
].message_type = google_dot_type_dot_date__pb2._DATE
_RETRIEVEPROMOTIONRESPONSE.fields_by_name[
    "discounts"
].message_type = promotion_dot_grpc_dot_v1alpha1_dot_discount__pb2._DISCOUNT
DESCRIPTOR.message_types_by_name[
    "CreateUserRequestResponse"
] = _CREATEUSERREQUESTRESPONSE
...
CreateUserRequestResponse = _reflection.GeneratedProtocolMessageType(
    "CreateUserRequestResponse",
    (_message.Message,),
    {
